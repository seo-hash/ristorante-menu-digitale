  ...
  return (
    <main className="min-h-screen bg-cream flex flex-col">
      ...
      {navItems && navItems.length > 0 && !customNav && (
        <nav className="bg-primary text-[#ECE4D4] px-4 py-3 text-center order-last sm:order-none sticky bottom-0 left-0 right-0 z-10 sm:sticky sm:top-0 sm:z-10 backdrop-blur-sm border-t sm:border-t-0 sm:border-b border-primary/20">
